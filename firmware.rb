...
def create_injector(device, for_usbhost, compressed_data, output_path)
  ...
  add_key_value(root_dict, "CFBundleIdentifier", "string", "as.devicemanager.BrcmInjector.%04x.%04x" % [ device.vendorId, device.productId ])
  ...
  add_key_value(device_dict, "CFBundleIdentifier", "string", for_usbhost ? "as.devicemanager.BrcmPatchRAM2" : "as.devicemanager.BrcmPatchRAM")
  ...
  add_key_value(firmware_dict, "CFBundleIdentifier", "string", "as.devicemanager.BrcmFirmwareStore")
...
def create_plist(devices, output_path, version)
  ...
  devices.sort_by{|d| [d.vendorId, d.productId]}.each do |device|
    ...
    add_key_value(device_xml, "CFBundleIdentifier", "string", "as.devicemanager.$(PRODUCT_NAME:rfc1034identifier)")
  ...
  if version >= 2
    ...
    add_key_value(residency_xml, "CFBundleIdentifier", "string", "as.devicemanager.$(PRODUCT_NAME:rfc1034identifier)")
